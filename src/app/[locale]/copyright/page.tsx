...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Grand Alfheim Wiki',
    description: 'Copyright and intellectual property information for Grand Alfheim Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Grand Alfheim Wiki',
      description: 'Copyright and intellectual property information for Grand Alfheim Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Grand Alfheim Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Grand Alfheim Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Grand Alfheim Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
            ...
            <p>
              ...
              affiliation with Grand Alfheim Wiki.
            </p>
            ...
            <p>
              ...
              Grand Alfheim Wiki<br />
              Email: <a href="mailto:dmca@grandalfheim.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@grandalfheim.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Grand Alfheim Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Grand Alfheim Wiki (grandalfheim.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@grandalfheim.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@grandalfheim.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@grandalfheim.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@grandalfheim.wiki</a>
            </p>
            <p>
